...
<h2><i class="halflings-icon edit"></i><span class="break"></span>Root Category Input Form UI</h2>
<div class="box-icon">
...
{!! Form::open(['route'=>'new-root','method'=>'POST','class'=>'form-horizontal'])!!}
  <fieldset>
	<div class="control-group">
	  <label class="control-label" for="typeahead">Root Category Name</label>
	  <div class="controls">
		<input placeholder="Please Enter Category" type="text" name="rootCategoryName" required>
	...
	<div class="control-group hidden-phone">
	  ...
	  <div class="controls">
		<textarea class="cleditor" id="textarea2" rows="3" name="rootCategoryDescription"></textarea>
	...
	<div class="form-actions">
	  <button type="submit" class="btn btn-primary">Save RootCategory Info</button>
