...
<div class="products">	 
	<div class="container">
		...
		<div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".5s">
			...
			<div class="new-top">
				<a href="single.html"><img src="{{ asset($categoryProduct->product_image) }}" class="img-responsive" alt=""/></a>
				<div class="new-text">
					<ul>
					...
					<div class="new-bottom">
						<h5><a class="name" href="single.html">{{ ($categoryProduct->product_name) }} </a></h5>
						<div class="rating">
							<span class="on">☆</span>
							<span class="on">☆</span>
							<span class="on">☆</span>
						...
						<div class="ofr">
							...
							<p><span class="item_price">Tk. {{ ($categoryProduct->product_price) }}</span></p>
						</div>
					</div>
				</div>
		@endforeach
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="gallery-grid ">
					...
					<a href="single.html"><img src="{{ asset('/') }}/front-end/images/b1.png" class="img-responsive" alt=""/></a>
