...
<div class="login-page">
		<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
			...
			<h3 class="title text-center">{{Session::get('message')}}</h3>
		</div>
		<div class="widget-shadow">
			<div class="login-top wow fadeInUp animated" data-wow-delay=".7s">
				<h4>Welcome back to Suba e-Commerce ! <br> Not a Member? <a href="{{ route('checkout')}}"> Please Register Now »</a> </h4>
			</div>
			<div class="login-body wow fadeInUp animated" data-wow-delay=".7s">
			{{ Form::open(['route'=>'customer-login-form', 'method'=>'post', 'class'=>'wow fadeInUp animated" data-wow-delay=".9s'])}}
